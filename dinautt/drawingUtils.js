...
function showDebugInfo(game, ctx) {
    ...
    ctx.fillText("gravity : " + game.player.gravity, 300, 700);
    ctx.fillText("jumping : " + game.player.jumping, 300, 900);
    ctx.fillText("grounded : " + game.player.grounded, 300, 1100);
    ctx.fillText("changingGravity : " + game.player.changingGravity, 300, 1300);
    ctx.fillText("difficulty : " + game.getDifficulty(), 300, 1500);
    ctx.fillText("speed : " + game.getSpeed(), 300, 1700);
    ctx.fillText("gamemode : " + game.gamemode, 1500, 300);
}
